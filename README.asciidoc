...
*:to-dir*:: Target directory. All generated files will be placed in this directory.

*:compact*:: Compact the output by removing blank lines. Possible values: true or false.

*:header-footer*:: Suppress or allow the document header and footer in the output.
.Example
NOTE:
It will render only `<body>` content for HTML mode.
